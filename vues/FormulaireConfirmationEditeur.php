...
<main>
    ...
    <form method="post" action="index.php?commande=SupprimerEditeur&id=<?=$_GET["id"]?>" class="formulaire">
        <div>
            <label>Êtes-vous sûr que vous voulez supprimer cet editeur?</label>        
        </div>
